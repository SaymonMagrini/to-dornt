    ...
    <div id="dashboardScreen">
        ...
        <nav class="header navbar navbar-dark">
            <div class="container-fluid">
                ...
                <span class="navbar-brand mb-0 h1"><?= $this->e($title ?? 'CRUD') ?> - To-dornt</span>
        ...
        <aside class="sidebar" id="sidebar">
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="/admin/users" data-page="users">
                    ...
                    <span>Usuários</span>
                </a> <a class="nav-link" href="/admin/tasks" data-page="tasks">
                ...
                <a class="nav-link" href="/admin/tags" data-page="tags">
                    <i class="bi bi-box-seam"></i>
                    <span>tags</span>
            </nav>
        </aside>
